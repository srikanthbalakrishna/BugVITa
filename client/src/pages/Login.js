...
function Login(props) {
    ...
    function handleClick(e){
       e.preventDefault()   
        axios.get('http://localhost:4000/api/users/login/'+user+'-'+pass)
