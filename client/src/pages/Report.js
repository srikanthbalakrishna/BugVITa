...
function Report(props) {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:4000/api/bugs/" + props.location.id)
      .then((response) => {
        ...
        <div class="flex flex-wrap ">
          <div class="w-full mx-auto my-4 bg-white border rounded-lg shadow-xl lg:w-1/4">
            <div class="p-6">
              ...
              <p class="mb-3 text-base leading-relaxed text-gray-500">
                {" "}
              ...
              <div class="flex flex-wrap justify-between">
                <Link to="./dashboard">
                  <button class="w-full px-10 py-2 mx-auto my-2 text-base font-medium text-gray-600 transition duration-500 ease-in-out transform rounded-md border-gray-50 bg-gray-50 focus:shadow-outline focus:outline-none focus:ring-2 ring-offset-current ring-offset-2 hover:bg-gray-100">
                    {" "}
                    Back{" "}
                  </button>
                </Link>
