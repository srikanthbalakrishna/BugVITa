      ...
      <div class="text-gray-700 bg-white border-t border-b ">
        <div class="flex flex-col flex-wrap p-5 mx-auto md:items-center md:flex-row">
          ...
          <div class="flex ml-auto">
            <Link to="./login">
              <button class="items-center px-8 py-2 ml-auto font-semibold text-white transition duration-500 ease-in-out transform bg-black rounded-lg hover:bg-gray-900 focus:ring focus:outline-none">
                Login
              </button>
            </Link>
            <Link to="./signup">
              <button class="items-center px-8 py-2 mt-4 ml-5 font-semibold text-black transition duration-500 ease-in-out transform bg-white border rounded-lg lg:inline-flex lg:mt-px hover:border-black0 hover:bg-black hover:text-white focus:ring focus:outline-none">
                Sign Up
                <svg
