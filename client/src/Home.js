...
import backgroundGIF from "../src/white_background.gif";
      ...
      <section class="text-gray-700 ">
        <div class="container flex flex-col items-center px-5 py-16 mx-auto md:flex-row lg:px-28">
          <div class="flex flex-col items-start w-full pt-0 mb-16 text-left lg:flex-grow md:w-1/2 xl:mr-20 md:pr-24 md:mb-0 ">
            <h1 class="mb-8 text-2xl font-bold tracking-tighter text-left text-black lg:text-6xl title-font">
              BugVITa{" "}
            </h1>
            <p class="mb-8 text-base leading-relaxed text-left text-blueGray-600 text-2xl">
          ...
          <div class="w-full lg:w-5/6 lg:max-w-lg md:w-1/2">
            <img
              ...
              alt="hero"
              src="https://images.unsplash.com/photo-1555066931-4365d14bab8c?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1950&q=80"
            />
          </div>
        </div>
      </section>
